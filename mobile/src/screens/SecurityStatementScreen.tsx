...
const SECURITY_URL = "https://www.steadiday.com/security.html";
...
export default function SecurityStatementScreen() {
  ...
  const handleCopyURL = async () => {
    await Clipboard.setStringAsync(SECURITY_URL);
  };

  const handleOpenInBrowser = () => {
    Linking.openURL(SECURITY_URL);
  };

  return (
    <ScreenErrorBoundary screenName="SecurityStatement">
              ...
              {loading && (
                <View className="absolute inset-0 z-10 items-center justify-center">
                  ...
                  <Text className="text-sm mt-3" style={{ color: colors.textSecondary }}>
                    Loading security statement...
                  </Text>
                </View>
              )}
              <WebView
                ref={webViewRef}
                source={{ uri: SECURITY_URL }}
